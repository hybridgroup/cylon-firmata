...
Adaptor.prototype.spiConfig = function(pin, enableParasiticPower) {
  this.board.sendOneWireConfig(pin, enableParasiticPower);
};

Adaptor.prototype.spiSearch = function(pin, callback) {
  this.board.sendOneWireSearch(pin, callback);
};

Adaptor.prototype.spiRead = function(pin, device, length, callback) {
  this.board.sendOneWireRead(pin, device, length, callback);
};

Adaptor.prototype.spiWrite = function(pin, device, buff) {
  this.board.sendOneWireWrite(pin, device, buff);
};

Adaptor.prototype.spiReset = function(pin) {
  this.board.sendOneWireReset(pin);
};

Adaptor.prototype.spiDelay = function(pin, delay) {
